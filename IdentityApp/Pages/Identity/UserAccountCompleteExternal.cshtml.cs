...
namespace IdentityApp.Pages.Identity
{
  ...
  public class UserAccountCompleteExternalModel : UserPageModel
  {
    ...
    public UserAccountCompleteExternalModel(UserManager<IdentityUser> usrMgr, SignInManager<IdentityUser> signMgr, TokenUrlEncoderService encoder)
    {
      UserManager = usrMgr;
    ...
    public async Task<IActionResult> OnGetCallbackAsync()
    {
      ...
      IdentityResult result = await UserManager.AddLoginAsync(IdentityUser, info); if (!result.Succeeded)
      {
    ...
    {
      if ((id == null || (IdentityUser = await UserManager.FindByIdAsync(id)) == null) && !TempData.ContainsKey("errorMessage"))
      {
